...
# loading the data:
BR_real_estate_appreciation = pd.read_csv(
...
# Displaying the selected city data from BR_real_estate_appreciation with just columns that are defined in the query:
st.dataframe(
