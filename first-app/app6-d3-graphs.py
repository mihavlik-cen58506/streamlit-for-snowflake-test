...
# streamlit.components.v1 - is an extension of the streamlit library that allows you to embed HTML, CSS, and JavaScript

tree, net = st.tabs(["Collapsible Tree", "Network Graph"])
with tree:
    with open(makeCollapsibleTree(df), "r", encoding="utf-8") as f:
        components.html(f.read(), height=1200, width=1800)
with net:
